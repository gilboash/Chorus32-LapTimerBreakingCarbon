...
//        SectionsPagerAdapter mSectionsPagerAdapter = new SectionsPagerAdapter(getSupportFragmentManager(), getResources());
        SectionsPagerAdapter mSectionsPagerAdapter = new SectionsPagerAdapter(this, getResources());
// For FragmentStateAdapter
        ...
        // Link TabLayout and ViewPager2 with titles
...
//        tabLayout.setupWithViewPager(mViewPager);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menuBTConnect) {
            ...
            useUDP();
        } else if (id == R.id.menuTCPConnect) {
            tcp.connect(getGatewayIP(), 0);
            useTCP();
        } else if (id == R.id.menuUSBConnect) {
